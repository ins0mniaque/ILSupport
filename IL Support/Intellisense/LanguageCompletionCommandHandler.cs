...
namespace ILSupport.Intellisense
{
    ...
    internal class LanguageCompletionHandlerProvider : IVsTextViewCreationListener
    {
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            Func<LanguageCompletionCommandHandler> createCommandHandler = delegate () { return new LanguageCompletionCommandHandler(textViewAdapter, textView, this); };
    ...
    internal class LanguageCompletionCommandHandler : IOleCommandTarget
    {
        ...
        private bool TriggerCompletion()
        {
         ...
         (m_textView,
            ...
            //wait to start
            while (m_session.IsStarted == false && m_session.IsDismissed == false)
            {

            }

            return m_session.IsStarted == false && m_session.IsDismissed == false;
        }
